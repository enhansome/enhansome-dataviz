...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 495,520 | 🐛 100 | 📅 2026-06-30 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 313,878 | 🐛 26 | 🌐 Python | 📅 2026-08-05 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,068 | 🐛 1,558 | 🌐 TypeScript | 📅 2026-08-04 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,288 | 🐛 846 | 🌐 JavaScript | 📅 2026-08-13 - Powerful declarative library with support for 20 chart types.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,247 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [diagram.js](https://github.com/bpmn-io/diagram-js) ⭐ 1,914 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-12 - Javascript diagram library serving as the basis for camunda's online BPMN modeler.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,567 | 🐛 1,641 | 🌐 JavaScript | 📅 2026-08-13 - WebGL 3D globes and maps.
...
* See [Awesome D3](https://github.com/wbkd/awesome-d3) ⭐ 5,313 | 🐛 5 | 📅 2023-01-13

### React

* [Recharts](https://github.com/recharts/recharts) ⭐ 27,500 | 🐛 446 | 🌐 TypeScript | 📅 2026-08-12 - Declarative react components to render D3 charts.
* [nivo](https://github.com/plouc/nivo) ⭐ 14,085 | 🐛 49 | 🌐 TypeScript | 📅 2026-07-21 - Supercharged dataviz components for React with isomorphic ability, [demo](https://nivo.rocks).
* [React-vis](https://github.com/uber/react-vis) ⭐ 8,786 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - React components to build data visualizations.
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,189 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,584 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 and React
...
* [Piecon](https://github.com/lipka/piecon) ⭐ 2,297 | 🐛 8 | 🌐 JavaScript | 📅 2022-10-12 - Pie charts in your favicon.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,111 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - open-source Qt5 application to plot charts (based on Qwt).
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,014 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code.
...
* [TensorWatch](https://github.com/microsoft/tensorwatch) ⭐ 3,471 | 🐛 54 | 🌐 Jupyter Notebook | 📅 2026-03-30 - Debugging and visualization tool for data science and machine learning

## Python tools

* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,288 | 🐛 846 | 🌐 JavaScript | 📅 2026-08-13
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,776 | 🐛 2 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,672 | 🐛 323 | 🌐 Python | 📅 2026-04-22 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,769 | 🐛 603 | 🌐 Python | 📅 2026-08-14 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,528 | 🐛 7 | 🌐 Ruby | 📅 2026-06-29 - Create charts with one line of Ruby.
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 89,750 | 🐛 1,699 | 🌐 TypeScript | 📅 2026-08-14 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,378 | 🐛 37 | 📅 2024-01-26.
