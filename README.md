...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,421 | 🐛 106 | 📅 2026-09-02 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 319,457 | 🐛 17 | 🌐 Python | 📅 2026-09-01 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,275 | 🐛 1,510 | 🌐 TypeScript | 📅 2026-09-04 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,320 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-09 - Powerful declarative library with support for 20 chart types.
...
* [React wrapper](https://github.com/hustcc/echarts-for-react) ⭐ 5,005 | 🐛 53 | 🌐 TypeScript | 📅 2026-01-21
...
* [G6](https://github.com/antvis/g6) ⭐ 12,287 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [diagram.js](https://github.com/bpmn-io/diagram-js) ⭐ 1,921 | 🐛 28 | 🌐 JavaScript | 📅 2026-09-09 - Javascript diagram library serving as the basis for camunda's online BPMN modeler.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,694 | 🐛 1,662 | 🌐 JavaScript | 📅 2026-09-08 - WebGL 3D globes and maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,061 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-08 - Large-scale WebGL-powered Geospatial Data Visualization analysis framework, maintained by Alibaba
...
* [Recharts](https://github.com/recharts/recharts) ⭐ 27,550 | 🐛 442 | 🌐 TypeScript | 📅 2026-09-09 - Declarative react components to render D3 charts.
...
* [React-vis](https://github.com/uber/react-vis) ⭐ 8,784 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - React components to build data visualizations.
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,187 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,605 | 🐛 185 | 🌐 TypeScript | 📅 2026-09-03 and React
...
* [F2](https://github.com/antvis/F2) ⭐ 7,991 | 🐛 303 | 🌐 JavaScript | 📅 2026-05-19 - An elegant, interactive and flexible charting library for mobile, maintained by Alibaba

### Misc

* [Piecon](https://github.com/lipka/piecon) ⭐ 2,295 | 🐛 8 | 🌐 JavaScript | 📅 2022-10-12 - Pie charts in your favicon.
* [Graphology](https://github.com/graphology/graphology) ⭐ 1,740 | 🐛 87 | 🌐 JavaScript | 📅 2026-09-02 - A robust & multipurpose Graph object for javascript & TypeScript; Serves as a base library to power other graph visualization libraries.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,182 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 - A powerful & easy to use chart library.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,170 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - open-source Qt5 application to plot charts (based on Qwt).
...
* [plot](https://github.com/gonum/plot) ⭐ 2,967 | 🐛 91 | 🌐 Go | 📅 2026-04-22 - API for building and drawing plots in Go.
* [svgo](https://github.com/ajstarks/svgo) ⭐ 2,250 | 🐛 16 | 🌐 Go | 📅 2022-12-09 - Go Language Library for SVG generation.

## iOS tools

* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,010 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code.
* [PNChart](https://github.com/kevinzhow/PNChart) ⭐ 9,640 | 🐛 173 | 🌐 Objective-C | 📅 2018-07-02 - A simple and beautiful chart lib used in Piner and CoinsMan.
* [JBChartView](https://github.com/Jawbone/JBChartView) ⭐ 3,695 | 🐛 10 | 🌐 Objective-C | 📅 2018-08-06 - Charting library for both line and bar graphs.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,320 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-09
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,772 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,689 | 🐛 327 | 🌐 Python | 📅 2026-04-22 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,803 | 🐛 558 | 🌐 Python | 📅 2026-09-08 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
* [ggplot](https://github.com/yhat/ggpy) ⚠️ Archived - plotting system based on [R's](#r-tools) ggplot2.
* [Chartify](https://github.com/spotify/chartify) ⭐ 3,640 | 🐛 55 | 🌐 Python | 📅 2024-10-16 - Bokeh wrapper that makes it easy for data scientists to create charts.
...
* [plotly](https://github.com/ropensci/plotly) ⭐ 2,679 | 🐛 760 | 🌐 R | 📅 2026-07-25 - Interactive charts (including adding interactivity to ggplot2 output), cartograms and simple network diagrams
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 90,178 | 🐛 1,775 | 🌐 TypeScript | 📅 2026-09-09 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,640 | 🐛 439 | 🌐 Java | 📅 2026-09-06 - An open-source platform for visualizing and manipulating large graphs
...
* [Visual-Insights](https://github.com/ObservedObserver/visual-insights) ⭐ 4,683 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-14 - Automatic insights extraction and visualization specification in data analysis.
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,410 | 🐛 39 | 📅 2024-01-26.
