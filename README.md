...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,048 | 🐛 106 | 📅 2026-09-02 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,832 | 🐛 26 | 🌐 Python | 📅 2026-09-18 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,355 | 🐛 1,504 | 🌐 TypeScript | 📅 2026-09-16 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,337 | 🐛 779 | 🌐 JavaScript | 📅 2026-09-17 - Powerful declarative library with support for 20 chart types.
* [dc.js](https://github.com/dc-js/dc.js) ⭐ 7,429 | 🐛 411 | 🌐 JavaScript | 📅 2024-07-31 is an multi-Dimensional charting built to work natively with crossfilter.
...
* [Epoch](https://github.com/epochjs/epoch) ⭐ 4,945 | 🐛 69 | 🌐 HTML | 📅 2019-02-14 - Perfect to create real-time charts.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,300 | 🐛 334 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [diagram.js](https://github.com/bpmn-io/diagram-js) ⭐ 1,923 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-15 - Javascript diagram library serving as the basis for camunda's online BPMN modeler.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,754 | 🐛 1,660 | 🌐 JavaScript | 📅 2026-09-18 - WebGL 3D globes and maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,063 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-08 - Large-scale WebGL-powered Geospatial Data Visualization analysis framework, maintained by Alibaba
...
* See [Awesome D3](https://github.com/wbkd/awesome-d3) ⭐ 5,323 | 🐛 5 | 📅 2023-01-13

### React

* [Recharts](https://github.com/recharts/recharts) ⭐ 27,573 | 🐛 447 | 🌐 TypeScript | 📅 2026-09-19 - Declarative react components to render D3 charts.
* [nivo](https://github.com/plouc/nivo) ⭐ 14,100 | 🐛 51 | 🌐 TypeScript | 📅 2026-07-21 - Supercharged dataviz components for React with isomorphic ability, [demo](https://nivo.rocks).
* [React-vis](https://github.com/uber/react-vis) ⭐ 8,786 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - React components to build data visualizations.
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,189 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,610 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-20 and React
* [Graphin](https://github.com/antvis/Graphin) ⭐ 1,099 | 🐛 64 | 🌐 TypeScript | 📅 2025-11-18 - Graph visualization library powered by React & Typescript (built on top of G6, maintained by Alibaba.
...
* [F2](https://github.com/antvis/F2) ⭐ 7,997 | 🐛 303 | 🌐 JavaScript | 📅 2026-05-19 - An elegant, interactive and flexible charting library for mobile, maintained by Alibaba

### Misc

* [Piecon](https://github.com/lipka/piecon) ⭐ 2,295 | 🐛 8 | 🌐 JavaScript | 📅 2022-10-12 - Pie charts in your favicon.
* [Graphology](https://github.com/graphology/graphology) ⭐ 1,748 | 🐛 88 | 🌐 JavaScript | 📅 2026-09-02 - A robust & multipurpose Graph object for javascript & TypeScript; Serves as a base library to power other graph visualization libraries.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,170 | 🐛 2,066 | 🌐 Java | 📅 2026-09-19 - A powerful & easy to use chart library.
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,101 | 🐛 35 | 🌐 Kotlin | 📅 2025-10-04 - Simple chart library.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,192 | 🐛 164 | 🌐 C++ | 📅 2026-09-20 - open-source Qt5 application to plot charts (based on Qwt).
...
* [go-echars](https://github.com/chenjiandongx/go-echarts) ⭐ 7,643 | 🐛 66 | 🌐 Go | 📅 2026-09-13 - Simple yet powerful data visualizing library for Go.
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,008 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code.
* [PNChart](https://github.com/kevinzhow/PNChart) ⭐ 9,635 | 🐛 173 | 🌐 Objective-C | 📅 2018-07-02 - A simple and beautiful chart lib used in Piner and CoinsMan.
* [JBChartView](https://github.com/Jawbone/JBChartView) ⭐ 3,693 | 🐛 10 | 🌐 Objective-C | 📅 2018-08-06 - Charting library for both line and bar graphs.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,337 | 🐛 779 | 🌐 JavaScript | 📅 2026-09-17
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,703 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,817 | 🐛 526 | 🌐 Python | 📅 2026-09-20 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
* [ggplot](https://github.com/yhat/ggpy) ⚠️ Archived - plotting system based on [R's](#r-tools) ggplot2.
* [Chartify](https://github.com/spotify/chartify) ⭐ 3,648 | 🐛 55 | 🌐 Python | 📅 2024-10-16 - Bokeh wrapper that makes it easy for data scientists to create charts.
...
* [plotly](https://github.com/ropensci/plotly) ⭐ 2,681 | 🐛 761 | 🌐 R | 📅 2026-07-25 - Interactive charts (including adding interactivity to ggplot2 output), cartograms and simple network diagrams
...
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,532 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - Create charts with one line of Ruby.
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 90,315 | 🐛 1,791 | 🌐 TypeScript | 📅 2026-09-18 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,653 | 🐛 444 | 🌐 Java | 📅 2026-09-20 - An open-source platform for visualizing and manipulating large graphs
...
* [Visual-Insights](https://github.com/ObservedObserver/visual-insights) ⭐ 4,686 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-14 - Automatic insights extraction and visualization specification in data analysis.
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,413 | 🐛 45 | 📅 2024-01-26.
