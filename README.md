...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,699 | 🐛 100 | 📅 2026-06-30 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,364 | 🐛 15 | 🌐 Python | 📅 2026-08-16 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,085 | 🐛 1,556 | 🌐 TypeScript | 📅 2026-08-04 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,294 | 🐛 849 | 🌐 JavaScript | 📅 2026-08-14 - Powerful declarative library with support for 20 chart types.
* [dc.js](https://github.com/dc-js/dc.js) ⭐ 7,430 | 🐛 412 | 🌐 JavaScript | 📅 2024-07-31 is an multi-Dimensional charting built to work natively with crossfilter.
* [NVD3](https://github.com/novus/nvd3) ⭐ 7,225 | 🐛 565 | 🌐 JavaScript | 📅 2023-09-15 - A reusable charting library written in d3.js.
...
* [React wrapper](https://github.com/hustcc/echarts-for-react) ⭐ 5,003 | 🐛 53 | 🌐 TypeScript | 📅 2026-01-21
...
* [G6](https://github.com/antvis/g6) ⭐ 12,252 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,572 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-15 - WebGL 3D globes and maps.
...
* [Recharts](https://github.com/recharts/recharts) ⭐ 27,506 | 🐛 444 | 🌐 TypeScript | 📅 2026-08-17 - Declarative react components to render D3 charts.
...
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,188 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,594 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 and React
...
* [Graphology](https://github.com/graphology/graphology) ⭐ 1,729 | 🐛 88 | 🌐 JavaScript | 📅 2026-07-21 - A robust & multipurpose Graph object for javascript & TypeScript; Serves as a base library to power other graph visualization libraries.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,195 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 - A powerful & easy to use chart library.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,116 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - open-source Qt5 application to plot charts (based on Qwt).
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,013 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,294 | 🐛 849 | 🌐 JavaScript | 📅 2026-08-14
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,776 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,772 | 🐛 600 | 🌐 Python | 📅 2026-08-17 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 89,802 | 🐛 1,704 | 🌐 TypeScript | 📅 2026-08-17 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,616 | 🐛 520 | 🌐 Java | 📅 2026-08-08 - An open-source platform for visualizing and manipulating large graphs
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,379 | 🐛 37 | 📅 2024-01-26.
