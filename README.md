...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,750 | 🐛 105 | 📅 2026-08-21 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 315,406 | 🐛 23 | 🌐 Python | 📅 2026-08-21 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,117 | 🐛 1,551 | 🌐 TypeScript | 📅 2026-08-04 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,296 | 🐛 845 | 🌐 JavaScript | 📅 2026-08-21 - Powerful declarative library with support for 20 chart types.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,268 | 🐛 332 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [diagram.js](https://github.com/bpmn-io/diagram-js) ⭐ 1,917 | 🐛 31 | 🌐 JavaScript | 📅 2026-08-18 - Javascript diagram library serving as the basis for camunda's online BPMN modeler.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,591 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-21 - WebGL 3D globes and maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,054 | 🐛 214 | 🌐 TypeScript | 📅 2026-07-30 - Large-scale WebGL-powered Geospatial Data Visualization analysis framework, maintained by Alibaba
* [DataMaps](https://github.com/markmarkoh/datamaps) ⭐ 3,800 | 🐛 229 | 🌐 JavaScript | 📅 2026-02-10 - Interactive SVG maps using D3.js.
...
* See [Awesome D3](https://github.com/wbkd/awesome-d3) ⭐ 5,315 | 🐛 5 | 📅 2023-01-13

### React

* [Recharts](https://github.com/recharts/recharts) ⭐ 27,514 | 🐛 439 | 🌐 TypeScript | 📅 2026-08-22 - Declarative react components to render D3 charts.
* [nivo](https://github.com/plouc/nivo) ⭐ 14,087 | 🐛 49 | 🌐 TypeScript | 📅 2026-07-21 - Supercharged dataviz components for React with isomorphic ability, [demo](https://nivo.rocks).
* [React-vis](https://github.com/uber/react-vis) ⭐ 8,787 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - React components to build data visualizations.
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,189 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,593 | 🐛 182 | 🌐 TypeScript | 📅 2026-07-15 and React
...
* [Graphology](https://github.com/graphology/graphology) ⭐ 1,730 | 🐛 88 | 🌐 JavaScript | 📅 2026-07-21 - A robust & multipurpose Graph object for javascript & TypeScript; Serves as a base library to power other graph visualization libraries.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,124 | 🐛 159 | 🌐 C++ | 📅 2026-08-10 - open-source Qt5 application to plot charts (based on Qwt).
...
* [go-echars](https://github.com/chenjiandongx/go-echarts) ⭐ 7,636 | 🐛 67 | 🌐 Go | 📅 2026-07-20 - Simple yet powerful data visualizing library for Go.
...
* [PNChart](https://github.com/kevinzhow/PNChart) ⭐ 9,645 | 🐛 173 | 🌐 Objective-C | 📅 2018-07-02 - A simple and beautiful chart lib used in Piner and CoinsMan.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,296 | 🐛 845 | 🌐 JavaScript | 📅 2026-08-21
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,776 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,681 | 🐛 325 | 🌐 Python | 📅 2026-04-22 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,777 | 🐛 598 | 🌐 Python | 📅 2026-08-22 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [glumpy](https://github.com/glumpy/glumpy) ⭐ 1,277 | 🐛 100 | 🌐 Python | 📅 2025-07-15 - OpenGL scientific visualizations library.
...
* [plotly](https://github.com/ropensci/plotly) ⭐ 2,675 | 🐛 759 | 🌐 R | 📅 2026-07-25 - Interactive charts (including adding interactivity to ggplot2 output), cartograms and simple network diagrams
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 89,877 | 🐛 1,718 | 🌐 TypeScript | 📅 2026-08-21 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,618 | 🐛 520 | 🌐 Java | 📅 2026-08-19 - An open-source platform for visualizing and manipulating large graphs
...
* [Visual-Insights](https://github.com/ObservedObserver/visual-insights) ⭐ 4,675 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-14 - Automatic insights extraction and visualization specification in data analysis.
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,384 | 🐛 39 | 📅 2024-01-26.
