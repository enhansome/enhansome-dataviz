...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,450 | 🐛 106 | 📅 2026-09-02 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,060 | 🐛 19 | 🌐 Python | 📅 2026-09-20 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,364 | 🐛 1,494 | 🌐 TypeScript | 📅 2026-09-16 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,337 | 🐛 782 | 🌐 JavaScript | 📅 2026-09-17 - Powerful declarative library with support for 20 chart types.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,301 | 🐛 334 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [diagram.js](https://github.com/bpmn-io/diagram-js) ⭐ 1,924 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-21 - Javascript diagram library serving as the basis for camunda's online BPMN modeler.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,760 | 🐛 1,661 | 🌐 JavaScript | 📅 2026-09-18 - WebGL 3D globes and maps.
...
* [Recharts](https://github.com/recharts/recharts) ⭐ 27,574 | 🐛 447 | 🌐 TypeScript | 📅 2026-09-20 - Declarative react components to render D3 charts.
...
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,189 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,611 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-21 and React
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,170 | 🐛 2,066 | 🌐 Java | 📅 2026-09-20 - A powerful & easy to use chart library.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,193 | 🐛 99 | 🌐 C++ | 📅 2026-09-21 - open-source Qt5 application to plot charts (based on Qwt).
...
* [go-echars](https://github.com/chenjiandongx/go-echarts) ⭐ 7,644 | 🐛 66 | 🌐 Go | 📅 2026-09-13 - Simple yet powerful data visualizing library for Go.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,337 | 🐛 782 | 🌐 JavaScript | 📅 2026-09-17
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,704 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,819 | 🐛 519 | 🌐 Python | 📅 2026-09-21 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 90,338 | 🐛 1,793 | 🌐 TypeScript | 📅 2026-09-21 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,652 | 🐛 444 | 🌐 Java | 📅 2026-09-20 - An open-source platform for visualizing and manipulating large graphs
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,414 | 🐛 45 | 📅 2024-01-26.
