...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,702 | 🐛 107 | 📅 2026-09-02 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 323,140 | 🐛 21 | 🌐 Python | 📅 2026-09-25 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,396 | 🐛 1,492 | 🌐 TypeScript | 📅 2026-09-16 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,346 | 🐛 796 | 🌐 JavaScript | 📅 2026-09-25 - Powerful declarative library with support for 20 chart types.
...
* [diagram.js](https://github.com/bpmn-io/diagram-js) ⭐ 1,926 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-25 - Javascript diagram library serving as the basis for camunda's online BPMN modeler.
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,774 | 🐛 1,687 | 🌐 JavaScript | 📅 2026-09-26 - WebGL 3D globes and maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,066 | 🐛 215 | 🌐 TypeScript | 📅 2026-09-08 - Large-scale WebGL-powered Geospatial Data Visualization analysis framework, maintained by Alibaba
...
* [Recharts](https://github.com/recharts/recharts) ⭐ 27,590 | 🐛 446 | 🌐 TypeScript | 📅 2026-09-25 - Declarative react components to render D3 charts.
* [nivo](https://github.com/plouc/nivo) ⭐ 14,102 | 🐛 52 | 🌐 TypeScript | 📅 2026-07-21 - Supercharged dataviz components for React with isomorphic ability, [demo](https://nivo.rocks).
* [React-vis](https://github.com/uber/react-vis) ⭐ 8,786 | 🐛 343 | 🌐 JavaScript | 📅 2024-12-18 - React components to build data visualizations.
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,189 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,618 | 🐛 182 | 🌐 TypeScript | 📅 2026-09-24 and React
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,171 | 🐛 1,991 | 🌐 Kotlin | 📅 2026-09-26 - A powerful & easy to use chart library.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,210 | 🐛 102 | 🌐 C++ | 📅 2026-09-23 - open-source Qt5 application to plot charts (based on Qwt).
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,005 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,346 | 🐛 796 | 🌐 JavaScript | 📅 2026-09-25
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,711 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,828 | 🐛 510 | 🌐 Python | 📅 2026-09-26 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 90,429 | 🐛 1,827 | 🌐 TypeScript | 📅 2026-09-21 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,656 | 🐛 444 | 🌐 Java | 📅 2026-09-26 - An open-source platform for visualizing and manipulating large graphs
