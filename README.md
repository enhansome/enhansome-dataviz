...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,571 | 🐛 106 | 📅 2026-09-02 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 320,974 | 🐛 19 | 🌐 Python | 📅 2026-09-15 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,335 | 🐛 1,502 | 🌐 TypeScript | 📅 2026-09-16 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,334 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-15 - Powerful declarative library with support for 20 chart types.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,296 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,741 | 🐛 1,657 | 🌐 JavaScript | 📅 2026-09-16 - WebGL 3D globes and maps.
...
* See [Awesome D3](https://github.com/wbkd/awesome-d3) ⭐ 5,319 | 🐛 5 | 📅 2023-01-13

### React

* [Recharts](https://github.com/recharts/recharts) ⭐ 27,559 | 🐛 447 | 🌐 TypeScript | 📅 2026-09-16 - Declarative react components to render D3 charts.
...
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,188 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,607 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-16 and React
...
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,100 | 🐛 35 | 🌐 Kotlin | 📅 2025-10-04 - Simple chart library.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,183 | 🐛 164 | 🌐 C++ | 📅 2026-08-10 - open-source Qt5 application to plot charts (based on Qwt).
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,006 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 -  iOS port of MPAndroidChart. You can create charts for both platforms with very similar code.
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,334 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-15
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,774 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,695 | 🐛 328 | 🌐 Python | 📅 2026-09-11 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,815 | 🐛 549 | 🌐 Python | 📅 2026-09-16 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 90,263 | 🐛 1,785 | 🌐 TypeScript | 📅 2026-09-15 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,650 | 🐛 444 | 🌐 Java | 📅 2026-09-13 - An open-source platform for visualizing and manipulating large graphs
