...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,608 | 🐛 105 | 📅 2026-08-21 ![Test](https://github.com/javierluraschi/awesome-dataviz/actions/workflows/main.yaml/badge.svg)

A curated list of awesome **open-source** data visualizations frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 317,313 | 🐛 18 | 🌐 Python | 📅 2026-08-25 and originally created by [fasouto](https://github.com/fasouto).
...
* [Echarts](https://github.com/ecomfe/echarts) ⭐ 67,204 | 🐛 1,522 | 🌐 TypeScript | 📅 2026-08-04 - Highly customizable and interactive charts ready for big datasets.
* [Plotly.js](https://github.com/plotly/plotly.js/) ⭐ 18,311 | 🐛 765 | 🌐 JavaScript | 📅 2026-08-30 - Powerful declarative library with support for 20 chart types.
...
* [TOAST UI Chart](https://github.com/nhnent/tui.chart) ⭐ 5,400 | 🐛 24 | 🌐 TypeScript | 📅 2023-10-05 - Complete library with support for legacy browsers.
...
* [G6](https://github.com/antvis/g6) ⭐ 12,278 | 🐛 333 | 🌐 TypeScript | 📅 2026-07-15 - Graph visualization library powered by Javascript & Typescript, maintained by Alibaba
...
* [Cesium](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,629 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-31 - WebGL 3D globes and maps.
...
* [Recharts](https://github.com/recharts/recharts) ⭐ 27,528 | 🐛 442 | 🌐 TypeScript | 📅 2026-08-31 - Declarative react components to render D3 charts.
...
* [BizCharts](https://github.com/alibaba/BizCharts) ⭐ 6,189 | 🐛 360 | 🌐 TypeScript | 📅 2025-05-23 - Data visualization library based on [G2](https://github.com/antvis/G2) ⭐ 12,599 | 🐛 183 | 🌐 TypeScript | 📅 2026-08-31 and React
...
* [Graphology](https://github.com/graphology/graphology) ⭐ 1,736 | 🐛 88 | 🌐 JavaScript | 📅 2026-08-31 - A robust & multipurpose Graph object for javascript & TypeScript; Serves as a base library to power other graph visualization libraries.
...
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,135 | 🐛 162 | 🌐 C++ | 📅 2026-08-10 - open-source Qt5 application to plot charts (based on Qwt).
...
* [plotly](https://plot.ly/python/) - Interactive web based visualization built on top of [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,311 | 🐛 765 | 🌐 JavaScript | 📅 2026-08-30
* [pyechars](https://github.com/pyecharts/pyecharts) ⭐ 15,774 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Python binding for Echarts library.
* [pandas-profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,684 | 🐛 325 | 🌐 Python | 📅 2026-04-22 - generates statistical analytic reports with visualization for quick data analysis.
...
* [PyVista](https://github.com/pyvista/pyvista) ⭐ 3,789 | 🐛 584 | 🌐 Python | 📅 2026-08-31 – 3D plotting and mesh analysis through a streamlined interface for the Visualization Toolkit (VTK)
...
* [plotly](https://github.com/ropensci/plotly) ⭐ 2,676 | 🐛 760 | 🌐 R | 📅 2026-07-25 - Interactive charts (including adding interactivity to ggplot2 output), cartograms and simple network diagrams
...
* [Chartkick](https://github.com/ankane/chartkick) ⭐ 6,527 | 🐛 7 | 🌐 Ruby | 📅 2026-08-15 - Create charts with one line of Ruby.
...
* [Mermaid](https://github.com/knsv/mermaid) ⭐ 90,011 | 🐛 1,760 | 🌐 TypeScript | 📅 2026-08-31 - A tool used to generate diagrams and flowcharts from text in a similar manner as markdown.
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,627 | 🐛 445 | 🌐 Java | 📅 2026-08-30 - An open-source platform for visualizing and manipulating large graphs
* [Spark](https://github.com/holman/spark) ⭐ 6,075 | 🐛 17 | 🌐 Shell | 📅 2022-05-07 - Sparklines for the shell. It have several [implementations in different languages](https://github.com/holman/spark/wiki/Alternative-Implementations) ⭐ 6,075 | 🐛 17 | 🌐 Shell | 📅 2022-05-07.
* [Visual-Insights](https://github.com/ObservedObserver/visual-insights) ⭐ 4,681 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-14 - Automatic insights extraction and visualization specification in data analysis.
...
If you have any question about this opinionated list, do not hesitate to contact me [@javierluraschi](https://twitter.com/javierluraschi) on Twitter or [open a GitHub issue](https://github.com/javierluraschi/awesome-dataviz/issues/new) ⭐ 4,402 | 🐛 39 | 📅 2024-01-26.
